...
DROP DATABASE IF EXISTS Boost13Db;
...
(
	...
	DogumYeriId INT NULL FOREIGN KEY REFERENCES Sehirler(Id)
);
GO
...
INSERT INTO Ogrenciler(DogumYeriId, Cinsiyet, DogumTarihi, EvliMi, MezuniyetNotu, CovidGecirdiMi, KanGrubu, Ad, Soyad)
VALUES
(0006,N'k', N'1997-04-17', 0, 2.96, 1, N'b-', N'İrem', N'Cengiz'),
(0006, N'e', N'1996-09-26', 0, 2.29, 0, N'a+', N'Serdar', N'Ünlü'),
(NULL, N'e', N'1993-02-25', 1, 2.93, 1, N'0+', N'Yasin', N'Gürbüz'),
(0043, N'k', N'1993-05-02', 1, 3.02, 0, N'0+', N'Gamze', N'Güzle Obuz'),
(0006, N'e', N'1995-08-17', 0, 2.44, 0, N'a+', N'Taylan', N'Saykan'),
(0006, N'e', N'1995-09-01', 0, 2.92, 1, N'a+', N'Sinan', N'Taşyapar'),
(0008, N'e', N'1998-09-13', 0, 2.75, 0, N'a-', N'Batuhan', N'Haybek'),
(0042, N'e', N'1995-11-02', 0, 2.60, 0, N'a+', N'Ozan', N'Genç'),
(0006, N'e', N'1997-06-21', 0, 2.48, 1, N'a-', N'Doğukan', N'Aslan'),
(0026, N'k', N'1996-05-10', 1, 2.52, 0, N'0-', N'Ceren', N'Şen Yazıcı'),
(0006, N'e', N'1991-09-10', 1, 2.44, 1, N'a-', N'Emrah', N'Sözlü'),
(0061, N'e', NULL, NULL, NULL, NULL, NULL, N'Kızıltan', N'Oral');
GO
